...
spl_autoload_register(function ($sClassName)
{
    ...
    if (strstr($sFileName, 'Apollina\\') && file_exists(__DIR__.DIRECTORY_SEPARATOR.str_replace('Apollina\\', '', $sFileName))) {

    	require __DIR__.DIRECTORY_SEPARATOR.str_replace('Apollina\\', '', $sFileName);
    }
});
